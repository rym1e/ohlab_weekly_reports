...
if __name__ == '__main__':
    ...
    train_loader = DataLoader(dataset=train_data, batch_size=64, shuffle=True,device = device)
    ...
    test_loader = DataLoader(dataset=test_data, batch_size=64, shuffle=True,device = device)
    ...
    # SGD，优化器，梯度下降算法e
    optimizer = torch.optim.SGD(model.parameters(), lr=0.14,device = device)  # lr:学习率
    # 加载模型
